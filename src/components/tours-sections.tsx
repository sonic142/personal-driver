...
const socialLinks = [
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/personaldrivertours.co/",
    bg: "#1877F2",
    color: "#ffffff",
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/personal-driver-fr/",
    bg: "#0A66C2",
    color: "#ffffff",
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@personaldriver1",
    bg: "#000000",
    color: "#ffffff",
    icon: (
      <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M12.525.02c1.8-.1 3.74.5 5.13 1.62V6.5h-2.13c-1.48-.05-2.62-.55-3.38-1.48V12c0 3.38-2.75 6.13-6.13 6.13S0 15.38 0 12s2.75-6.13 6.13-6.13c.35 0 .7.03 1.04.1v2.52c-.35-.1-.7-.15-1.05-.15-1.98 0-3.58 1.6-3.58 3.58s1.6 3.58 3.58 3.58 3.58-1.6 3.58-3.58c0-.2 0-.4-.03-.58h.03V0h2.9v.02zM19.63 6.5V3.55c-.85.45-1.76.72-2.7.8v2.15h2.7z" />
      </svg>
    ),
  },
  {
